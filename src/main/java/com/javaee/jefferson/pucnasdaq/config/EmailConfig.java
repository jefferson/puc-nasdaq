...
public class EmailConfig {
	...
	private static UserEmailConfig userEmailConfig = new UserEmailConfig();
	...
	public void sendEmail(String toEmail,  String subject,  String body){
		try {
		    ...
		    AuthEmail authEmail = userEmailConfig.getPropValues();
		    
			Authenticator auth = configAuth(authEmail.getUser(), authEmail.getPassword());
